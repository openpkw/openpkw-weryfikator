...
public class ElectionCommittee implements Serializable {
    ...
    @GeneratedValue(generator = "election_committee_seq_gen", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "election_committee_seq_gen", sequenceName = "election_committee_seq", allocationSize = 1, initialValue = 10)
