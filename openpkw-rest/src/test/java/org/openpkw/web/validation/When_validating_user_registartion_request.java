...
public class When_validating_user_registartion_request {
    ...
    public void should_return_error_if_user_first_name_is_not_provided() {
        RegisterUserRequest request = new UserRegisterBuilder().withLastName("last-name").withEmail("email").withType(UserType.ADMINISTRATOR).withPassword("asfd").build();
    ...
    public void should_return_error_if_user_last_name_is_not_provided() {
        RegisterUserRequest request = new UserRegisterBuilder().withFirstName("first-name").withEmail("email").withType(UserType.ADMINISTRATOR).withPassword("asfd").build();
    ...
    public void should_return_error_if_user_email_is_not_provided() {
        RegisterUserRequest request = new UserRegisterBuilder().withFirstName("first-name").withLastName("last-name").withType(UserType.ADMINISTRATOR).withPassword("asfd").build();
    ...
    public void should_return_error_if_user_type_is_not_provided() {
        RegisterUserRequest request = new UserRegisterBuilder().withFirstName("first-name").withLastName("last-name").withEmail("email").withPassword("asfd").build();
        expectException(() -> cut.validateUserRegistration(request), RestClientErrorMessage.USER_TYPE_IS_MANDATORY.getErrorCode());
    }

    @Test
    public void should_return_error_if_user_password_is_not_provided() {
        RegisterUserRequest request = new UserRegisterBuilder().withFirstName("first-name").withLastName("last-name").withEmail("email").withType(UserType.ADMINISTRATOR).build();
